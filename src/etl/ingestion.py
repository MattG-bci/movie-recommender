from etl.generation.generate import generate_usernames, generate_movie_ratings, generate_movies
from etl.sql_queries import upsert_to_db, insert_usernames, fetch_usernames_from_db, upsert_movie_ratings
